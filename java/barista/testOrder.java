...
public class testOrder {
    public static void main(String[] args) {
        ...
        System.out.println(orders[0].getItems());

        System.out.println(orders[0].getTotal());
        ...
        System.out.println(orders[0].getStatus());
        orders[0].display();

        System.out.println(orders[0].calculateTotal());
